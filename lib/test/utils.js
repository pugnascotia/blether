...
var blether = require("../../build/blether.js");
...
testUtils.generateAndCompare = function(artifactPrefix) {
	...
	try {
		actual = normalise(blether.translate(artifacts.source, { runtime: false }));
	}
	catch (e) {
    ...
    try {
        ...
        _eval(blether.translate(artifacts.source), artifactPrefix, null, true);
    }
    catch (err) {
